...
def count_stop_words(text: str, stop_words: List[str]) -> int:
    ...
    if st.button("Analyze Content", key="analyze_button"): # MODIFIED: Line 290
        ...
        st.markdown(
            ...
            .report-section {
                ...
                box-shadow: 0 0.3rem 1rem rgba(0, 0, 0, 0.08); /* Softer, more diffused shadow */
            }
            .report-title {
                color: #007bff; /* Professional blue for titles */
                font-size: 2rem; /* Slightly larger title */
                margin-bottom: 1.5rem; /* Increased margin */
                border-bottom: 2px solid #ced4da; /* Neutral border */
            ...
            .metric-value {
                color: #6c757d; /* Consistent grey for values */
            ...
            .sentiment-box {
                ...
                font-weight: 700; /* Bolder */
                box-shadow: 0 0.2rem 0.6rem rgba(0,0,0,0.1); /* Softer shadow */
            }
            .positive {
